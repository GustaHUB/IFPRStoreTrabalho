            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/sellers/delete?id=<%= seller.getId() %>" class="btn btn-sm btn-danger">Editar</a>
                            <a href=/sellers/update?id=<%= seller.getId() %>" class="btn btn-sm btn-primary">Excluir</a>
                        </td>
                    </tr>
                    <% } %>
